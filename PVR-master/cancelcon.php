...
$query1="SELECT * FROM moviereport WHERE bookingid='$id'";
$data1=mysql_query($query1);

$total=mysql_num_rows($data1);
if($total!=0)
{
...
$query4="SELECT * FROM userbalanceinfo WHERE name='$name'";
...
$query7="DELETE FROM moviereport WHERE bookingid='$id'";  //dont use stars on delete stucked here
